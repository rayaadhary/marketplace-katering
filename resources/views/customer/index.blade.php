                            ...
                            @foreach ($all_menu as $key => $item)
                                <div class="carousel-item {{ $key == 0 ? 'active' : '' }} rounded">
                                    <img src="{{ asset('storage/'.$item->image) }}" class="img-fluid rounded"
                                        style="width: 500px; height: 300px;" alt="img-slide">
                                    <a href="{{ route('menu-customer') }}"
                                        class="btn px-4 py-2 text-white rounded text-capitalize">{{ $item->kategori }}</a>
                                </div>
                            @endforeach
                        </div>
                                    ...
                                    @foreach ($paket_pagi as $item)
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute text-capitalize text-capitalize"
                                                    style="top: 10px; left: 10px;">{{ $item->kategori }}</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4 class="text-capitalize">{{ $item->name }}</h4>
                                                    <p>{{ $item->description }}</p>
