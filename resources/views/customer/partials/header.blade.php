        ...
        <div class="d-flex justify-content-between">
            <div class="top-info ps-2">
                <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#"
                        class="text-white">Jl. Dipati Ukur No.77 A</a></small>
                <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#"
                        class="text-white">marketplace@email.com</a></small>
            </div>
    ...
    <div class="container px-0">
        <nav class="navbar navbar-light bg-white navbar-expand-xl">
            <a href="{{ url('/') }}" class="d-flex align-items-center navbar-brand">
                <img src="{{ asset('customer/img/logo-td-circle.png') }}" style="width: 80px; height: 80px;"
                    alt="logo">
            ...
            <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <a href="{{ route('menu-customer') }}"
                        class="nav-item nav-link {{ $title === 'Menu' || $title === 'Menu Detail' ? 'active' : '' }}">Menu</a>
